...
var statuses = require('./repos/statuses.js');
var contents = require('./repos/contents.js');
var releases = require('./repos/releases.js');
...
function Repos(api)
{
  ...
  this.contents = new contents(api);
  this.releases = new releases(api);
