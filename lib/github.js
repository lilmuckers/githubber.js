...
function GitHub(client_id, secret, scope, callbackUrl)
{
  ...
  this.userAgent = 'Githubber.js version '+this.version;
  //this.accessUrl = 'http://requestb.in/1kph6dt1';
}

GitHub.prototype.setUserAgent = function(userAgent){
...
GitHub.prototype._send = function(url, token, data, method, callback)
{
  ...
  //make sure to merge in all the provided get params as well
  for(var key in parsedUrl.query){
    getQuery[key] = parsedUrl.query[key];
  }
